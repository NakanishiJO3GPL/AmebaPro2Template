list (
    ...
    "${sdk_root}/mbed/targets/hal/rtl8735b"
	"${sdk_root}/mbed/api"
    "${sdk_root}/stdlib"
    "${sdk_root}/at_cmd"
    "${sdk_root}/network"
    ...
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/include"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/source/ram_ns/halmac/halmac_88xx"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/host/storage/inc/quirks"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/device/class/ethernet/inc"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/source/ram_ns/halmac/halmac_88xx/halmac_8822b"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/include"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/device/class/ethernet/src"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/device/core/inc"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/source/ram_ns/halmac/halmac_88xx/halmac_8735b"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/source/ram_ns/halmac/halmac_88xx_v1"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/device/class/vendor/inc"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/host/storage/inc"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/host/storage/inc/scatterlist"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/source/ram_ns/halmac/halmac_88xx/halmac_8821c"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/host/vendor_spec"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/source/ram_ns/halmac"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/source/ram_ns/halmac/halmac_88xx_v1/halmac_8814b"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/host/storage/inc/scsi"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/inc"
    "${sdk_root}/soc/8735b/fwlib/rtl8735b/source/ram_ns/halmac/halmac_88xx/halmac_8195b"
	"${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/usb_otg/device"

    "${sdk_root}/soc/8735b/misc/utilities/include"

    "${sdk_root}/soc/8735b/app/stdio_port"
    "${sdk_root}/soc/8735b/app/xmodem/rom"
    "${sdk_root}/soc/8735b/app/shell"
    "${sdk_root}/soc/8735b/app/shell/rom_ns"
    "${sdk_root}/soc/8735b/app/rtl_printf/include"

    "${prj_root}/rtos/os_dep/include"
    "${prj_root}/rtos/freertos"
    "${prj_root}/rtos/freertos/${freertos}/Source/include"

    "${sdk_root}/wifi/driver/include"
    "${sdk_root}/wifi/driver/src/osdep"
	"${sdk_root}/wifi/driver/src/phl"
    "${sdk_root}/wifi/driver/src/hal"
    "${sdk_root}/wifi/driver/src/hal/halmac"
    "${sdk_root}/wifi/driver/src/hci"
    "${sdk_root}/wifi/driver/src/hal/phydm/rtl8735b"
    "${sdk_root}/wifi/driver/src/hal/phydm"
    "${sdk_root}/wifi/wpa_supplicant/wpa_supplicant"

    "${prj_root}/rtos/freertos/freertos_posix/lib/include/FreeRTOS_POSIX"
    "${prj_root}/rtos/freertos/freertos_posix/lib/include"
    "${prj_root}/rtos/freertos/freertos_posix/lib/FreeRTOS-Plus-POSIX/include/portable/realtek/rtl8735b"
    "${prj_root}/rtos/freertos/freertos_posix/lib/FreeRTOS-Plus-POSIX/include"
    "${prj_root}/rtos/freertos/freertos_posix/lib/include/private"

	"${sdk_root}/lwip/api"
    "${sdk_root}/lwip/${lwip}/src/include"
    "${sdk_root}/lwip/${lwip}/src/include/lwip"
    "${sdk_root}/lwip/${lwip}/src/include/compat/posix"
    "${sdk_root}/lwip/${lwip}/port/realtek"
    "${sdk_root}/lwip/${lwip}/port/realtek/freertos"

	"${sdk_root}/ssl/${mbedtls}/include"
	"${sdk_root}/ssl/ssl_ram_map/rom"


	"${sdk_root}/usb/usb_class/device/class"
	"${sdk_root}/usb/usb_class/device"
	"${sdk_root}/usb/usb_class/host/uvc/inc"
	"${sdk_root}/video/driver/common"
	"${sdk_root}/video/driver/RTL8735B"
	"${sdk_root}/media/rtp_codec"
	"${sdk_root}/media/samples"

	"${sdk_root}/media/mmfv2"

    "${sdk_root}/wifi/api"
    "${sdk_root}/wifi/wifi_config"
	"${sdk_root}/wifi/wifi_fast_connect"

	"${sdk_root}/sdio/sd_host/inc"
	"${sdk_root}/file_system/fatfs"
	"${sdk_root}/file_system/fatfs/r0.14"
	"${sdk_root}/file_system/ftl_common"
	"${sdk_root}/file_system/vfs"

	"${sdk_root}/file_system/littlefs"
	"${sdk_root}/file_system/littlefs/r2.41"

	"${sdk_root}/audio/3rdparty/faac/libfaac"
	"${sdk_root}/audio/3rdparty/faac/include"

	"${sdk_root}/audio/3rdparty/haac"
	"${sdk_root}/media/muxer"

	"${sdk_root}/media/3rdparty/fmp4/libmov/include"
	"${sdk_root}/media/3rdparty/fmp4/libflv/include"

	"${sdk_root}/soc/8735b/cmsis/cmsis-dsp/include"

	"${sdk_root}/application/qr_code_scanner/inc"
	"${sdk_root}/audio/3rdparty/speex/speex"
	"${sdk_root}/audio/3rdparty/AEC/AEC"
	"${sdk_root}/audio/3rdparty/opus-1.3.1/include"
	"${sdk_root}/audio/3rdparty/libopusenc-0.2.1/include"
	"${sdk_root}/audio/3rdparty/fdk-aac-2.0.2/libAACenc/include"
	"${sdk_root}/audio/3rdparty/fdk-aac-2.0.2/libAACdec/include"
	"${sdk_root}/audio/3rdparty/fdk-aac-2.0.2/libSYS/include"

	"${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/video"
	"${sdk_root}/soc/8735b/fwlib/rtl8735b/lib/source/ram/video/semihost"
	"${sdk_root}/soc/8735b/cmsis/voe/rom"
